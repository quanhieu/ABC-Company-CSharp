...
public partial class cms_admin_SanPham_QuanLyNhomSanPham_Ajax_GroupProduct : System.Web.UI.Page
{
    string thaotac = "";
    ...
    private void DeleteGroupProduct()
    {
        string groupid = "";
        if (Request.Params["groupid"] != null)
        {
            ...
            abcompany.GroupProduct.GroupProduct_Delete(groupid);
