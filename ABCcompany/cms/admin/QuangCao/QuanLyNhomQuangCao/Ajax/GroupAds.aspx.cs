...
public partial class cms_admin_QuangCao_QuanLyNhomQuangCao_Ajax_GroupAds : System.Web.UI.Page
{
    ...
    private void DeleteGroupAds()
    {
        string groupadsid = "";
        if (Request.Params["groupadsid"] != null)
        {
            groupadsid = Request.Params["groupadsid"];

            //Thực hiện code xóa
            //B1: Xóa ảnh đại diện đã lưu trên server - tạm b
            //B2: Xóa dữ liệu trên sqlserver
            abcompany.GroupAds.GroupAds_Delete(groupadsid);
