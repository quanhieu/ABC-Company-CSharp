...
<div id="NewDetail">
    ...
    <div class="tool">
        <div class="date">Post date: <asp:Literal ID="ltrNgayDang" runat="server"></asp:Literal></div>
        <div class="view">Views: <asp:Literal ID="ltrLuotXem" runat="server"></asp:Literal></div>               
        <div class="cb"><!----></div>
    </div>
